...
scores = {}
path_scores = 'lr_fast_exp_runs/scores_lr' + str(datetime.datetime.now())[:19] + '.json'
with open(path_scores, 'w') as fp:
    json.dump(scores, fp)

path_dict = 'lr_fast_exp_runs/param_dict_lr' + str(datetime.datetime.now())[:19] + '.json'
